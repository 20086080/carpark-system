...
[](![](.\images\unit-tests-display2.png))
...
> Ideally the CarPark unit test because register method is part of the CarPark class and should be tested as part of that unit test.  
